...
Conforme ELMASRI e NAVATHE (2019), o modelo relacional é um modelo de dados que permite a representação dos dados na forma de tabelas, sendo que cada qual representa uma entidade e cada linha representa uma instância dessa entidade. Na terminologia formal, cada linha é chamada de tupla, o cabeçalho da coluna é chamado de atributo e a tabela em si é chamada de relação.  
